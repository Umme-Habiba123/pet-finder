          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl mx-auto">
            ...
            <div className={`space-y-6 ${isVisible ? 'animate-fade-in-left delay-400' : 'opacity-0'}`}>
              ...
              <div className="pt-4">
                <Link 
                  href="/contact"
                  className="btn bg-white hover:bg-gray-100 text-black border-none px-8 lg:px-10 py-3 text-base lg:text-lg font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                >
                  CONTACT US
                </Link>
              </div>
