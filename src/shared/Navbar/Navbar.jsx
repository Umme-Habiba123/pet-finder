          ...
          <div className="flex items-center justify-between h-20 lg:h-24">
                  ...
                  {link.hasDropdown ? (
                    <details className="dropdown dropdown-hover">
                      ...
                      <ul className="dropdown-content menu bg-base-100 rounded-lg shadow-lg border border-base-300 p-2 w-52 mt-2">
                        <li>
                          <Link
                            href={`${link.href}/option1`}
                            className="text-accent-yellow hover:bg-base-200"
                          >
                            Option 1
                          </Link>
                        </li>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {theme === "light" ? (
                  <svg
                    className="w-5 h-5 fill-current text-accent-yellow"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="lg:hidden">
                <label
                  ...
                  className="btn btn-circle btn-ghost drawer-button hover:bg-base-200 transition-colors duration-200"
                >
                  <svg
                    ...
                    {link.hasDropdown ? (
                      <details className="collapse collapse-arrow bg-base-200 rounded-lg">
                        <summary className="collapse-title font-medium text-base text-accent-yellow">
                          {link.name === "Home" && (
                            <span className="star-icon mr-1">⭐</span>
                          )}
                        ...
                        <div className="collapse-content">
                          <ul className="space-y-1 mt-2">
                            <li>
                              <Link
                                href={`${link.href}/option1`}
                                className="block p-3 rounded-lg hover:bg-base-300 transition-colors text-accent-yellow"
                              >
                                Option 1
                              </Link>
                            </li>
